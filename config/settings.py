...
CSRF_TRUSTED_ORIGINS = env.list(
    ...
    default=['https://europeptiva.com', 'https://www.europeptiva.com'],
)
...
# El español se sirve en la raíz (/) y el inglés bajo prefijo (/en/), así que
# las URLs que ya están indexadas no cambian. Ver prefix_default_language en
# config/urls.py.
LANGUAGES = [
    ('es', 'Español'),
    ('en', 'English'),
